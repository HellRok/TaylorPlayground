...
# Playground v0.4.3
FROM hellrok/taylor:web-v0.4.3 AS playground-v0.4.3
WORKDIR /app
COPY app/playgrounds/v0.4 bin/docker/build-playground /app/game/
COPY app/playgrounds/assets /app/game/assets/
RUN /app/game/build-playground

# Playground v0.4.2
FROM hellrok/taylor:web-v0.4.2 AS playground-v0.4.2
WORKDIR /app
COPY app/playgrounds/v0.4 bin/docker/build-playground /app/game/
COPY app/playgrounds/assets /app/game/assets/
RUN /app/game/build-playground
...
# Playground v0.4.1
FROM hellrok/taylor:web-v0.4.1 AS playground-v0.4.1
WORKDIR /app
COPY app/playgrounds/v0.4 bin/docker/build-playground /app/game/
COPY app/playgrounds/assets /app/game/assets/
RUN /app/game/build-playground
...
WORKDIR /app
COPY app/playgrounds/v0.3 bin/docker/build-playground /app/game/
COPY app/playgrounds/assets /app/game/assets/
RUN /app/game/build-playground
...
COPY --from=playground-v0.4.3 /app/game/exports /app/html/v0.4.3/
COPY --from=playground-v0.4.2 /app/game/exports /app/html/v0.4.2/
COPY --from=playground-v0.4.1 /app/game/exports /app/html/v0.4.1/
